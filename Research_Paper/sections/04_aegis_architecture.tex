...
\midrule
Climate (C) & ERA5 total precipitation & 7-day rolling precipitation sum, 30-day anomaly, soil-moisture column & Per cell-day $\omega_C$ \\
Satellite (S) & Sentinel-1 SAR + Sentinel-2 optical & VV, VH, VV/VH ratio, NDWI, NDVI & Per cell-day $\omega_S$ \\
Land-Cover (L) & ESA WorldCover + Copernicus DEM & Static class index, slope, elevation & Per pass $\omega_L$ \\
Air-Quality / Gauge (A) & OpenAQ PM2.5 + gauge network & PM2.5 washout signal, relative humidity, gauge precipitation & Per hour-aggregated cell-day $\omega_A$ \\
